...
const BASE_URL = 'https://github.com/yourusername/glucotrack/releases/latest/download';

function getDownloadUrl() {
    switch(platform) {
        case 'win32':
            return `${BASE_URL}/GlucoTrack-Setup-${version}.exe`;
        case 'darwin':
            return `${BASE_URL}/GlucoTrack-${version}.dmg`;
        case 'linux':
            return `${BASE_URL}/GlucoTrack-${version}.AppImage`;
        default:
...
async function install() {
    console.log('Installing GlucoTrack...');
